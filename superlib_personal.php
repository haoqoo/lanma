...
<div class="main">  
  <div class="content">    
    <div class="here"><a href="index.php">首页</a> >> <a href="products.php">产品</a>   >> <a href="superlib_personal.php">单机版</a> >> 概述</div>
    <div class="con_m"> 
      ...
      <div class="con_r">
        ...
        <div class="image"><img src="images/screen_shot.png" alt=""></div>
...
<p>SuperLib软件个人版将图片资源、相片资源、图纸资源、照片资源存放在电脑中，可以为文件添加说明、自定义属性、进行多重分类，并且具有自动识别重复文件的功能。可以实现资源的快速搜索。</p>
        </div>
        </div>
      </div>
      <div class="clear"></div>
